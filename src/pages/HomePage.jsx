	...
	return (
		...
		<Hero title='Ochronka Jurek w Poznaniu'>
			...
			<section id="aboutJUREK" className="section section--margin about">
				...
				<div className="about__box">
					<p className="section__text about__item-1">
						...
						przywrócić poczucie bezpieczeństwa. Indywidualny kontakt dziecka z opiekunem sprzyja wyjaśnieniu mu przyczyn
						trudnej sytuacji życiowej, a także ułatwia pracę z dzieckiem w celu zaakceptowania nowej rzeczywistości.
					</p>
					...
					<p className="section__text about__item-3">
						...
						<br />
						<br />
						Ochronka otrzymuje na swoją działalność dofinansowanie z Miasta Poznania. Wkład własny zapewniają darczyńcy,
						firmy, fundacje i osoby indywidualne.
					</p>
			...
			<section id='supportJUREK' className="section   support ">
				<div className="wrapper section--margin">
				...
				<ul className="section__ul">
					...
					<li className="section__li">Nivea w Poznaniu</li>
					<li className="section__li">COMPOL w Poznaniu</li>
					<li className="section__li">Bank ING w Poznaniu</li>
				</ul>
				</div>
			...
			<div 
			className='contact__links contact__links--center'
			>
				<img className="contact__icon" src={facebookLogo}></img>
				<a 
				className='contact__link' 
			
				href="https://www.facebook.com/p/Ochronka-Jurek-100072266557144/" target="_blank">
